    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_message', models.CharField(blank=True, help_text='Configuration error', max_length=255, null=True)),
                ('event', fullctl.django.fields.service_bridge.ReferencedObjectField(blank=True, bridge_type='event', help_text='auditCtl event reference', null=True)),
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='operational_status', to='django_devicectl.device')),
            ],
            options={
